package com.trinhthanhnam.de4_c2.adapter;
...
import com.trinhthanhnam.de4_c2.MainActivity;
import com.trinhthanhnam.de4_c2.R;
...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtInfor.setText("Mã sản phẩm: " + p.getCode() + "\n"
